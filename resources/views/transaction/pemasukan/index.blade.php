<x-app-layout>
    <x-card>
        <x-slot:header>Data Transaksi Pemasukan</x-slot:header>

        <div class="mb-5">
            <x-button class="btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-pemasukan">Tambah Data</x-button>
        </div>
...
<script>
    function getData() {
        var table = $('#table').DataTable({
            ...
            ajax: {
                url : "{{ url('transactions/pemasukan/list') }}",
                type: 'post',
...
@push('modal')
@include('transaction.pemasukan.modal-add')
@include('transaction.pemasukan.modal-edit')
@endpush
</x-app-layout>
