<x-app-layout>
    <x-card>
        <x-slot:header>Data Transaksi Pengeluaran</x-slot:header>

        <div class="mb-5">
            <x-button class="btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-pengeluaran">Tambah Data</x-button>
        </div>
        ...
        <table id="table" class="table table-bordered" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th class="text-center text-nowrap">Dari Akun</th>
...
<script>
    function getData() {
        var table = $('#table').DataTable({
            ...
            ajax: {
                url : "{{ url('transactions/pengeluaran/list') }}",
                type: 'post',
            ...
            columns: [
                ...
                { data: 'akun_id', class: 'text-nowrap', render: function(dat, type, row) {
                    return row.akun?.akun;
                }},
                { data: 'kas_id', class: 'text-nowrap', render: function(dat, type, row) {
                    return row.kas?.nama_kas;
                }},
...
@push('modal')
@include('transaction.pengeluaran.modal-add')
@include('transaction.pengeluaran.modal-edit')
@endpush
</x-app-layout>
